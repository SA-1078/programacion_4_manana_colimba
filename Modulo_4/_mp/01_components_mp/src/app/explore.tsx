    ...
    <ScrollView
      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.titleContainer}>
          <ThemedText type="subtitle">Catálogo Móvil - MobileStore</ThemedText>
          <ThemedText style={styles.centerText} themeColor="textSecondary">
            App de Venta de Equipos Móviles{'\n'}explora modelos, ofertas y especificaciones.
          </ThemedText>

          <ExternalLink href="https://docs.expo.dev" asChild>
            <Pressable style={({ pressed }) => pressed && styles.pressed}>
              <ThemedView type="backgroundElement" style={styles.linkButton}>
                <ThemedText type="link">Documentación Tienda</ThemedText>
                <SymbolView
        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="Navegación por catálogo">
            <ThemedText type="small">
              Esta aplicación cuenta con catálogo principal: <ThemedText type="code">src/app/index.tsx</ThemedText> y{' '}
              <ThemedText type="code">src/app/explore.tsx</ThemedText>
            </ThemedText>
          </Collapsible>

          <Collapsible title="Compatibilidad Móvil">
