      ...
      3 => const Scaffold(
            body: Center(
              child: Wrap(
                ...
                runSpacing: 8,
                children: [
                  Etiqueta(texto: 'Activo',    color: Colors.green,  icono: Icons.check_circle,   relleno: true),
                  Etiqueta(texto: 'Error',     color: Colors.red,    icono: Icons.error,           relleno: true),
                  Etiqueta(texto: 'En espera', color: Colors.orange, icono: Icons.hourglass_empty, relleno: true),
                  Etiqueta(texto: 'Crítico',   color: Colors.red,    icono: Icons.gavel,           fontSize: 16, relleno: true),
                  Etiqueta(texto: 'Info',      color: Colors.blue,   icono: Icons.info,            fontSize: 11, relleno: true),
                ],
              ),
            ),
          ),
