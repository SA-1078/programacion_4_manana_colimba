...
class _ServicioEstadoState extends State<ServicioEstado> {
  bool   _activo    = true;
  int    _reinicios = 0;
  String _nivel     = 'normal'; // 'normal' | 'warning' | 'critico'

  static const int _maxReinicios = 1; // bloqueo al primer reinicio
  ...
  void _toggle() {
    setState(() {
      ...
      if (_activo) {
        _reinicios++;
        if (_reinicios == 1) _nivel = 'warning';
        if (_reinicios >= 2) _nivel = 'critico';
      }
    });
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(
            _activo ? Icons.wifi : Icons.wifi_off, // wifi en lugar de check/cancel
            size:  72,
            color: _nivelColor,                    // color según nivel
          ),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontStyle:  _activo ? FontStyle.normal : FontStyle.italic, // italic cuando inactivo
          ...
          ElevatedButton.icon(                           // ElevatedButton en lugar de FilledButton
          ...
          Opacity(
            opacity: enLimite ? 0.1 : 1.0,              // 0.1 = casi invisible en límite
            child: Text(
