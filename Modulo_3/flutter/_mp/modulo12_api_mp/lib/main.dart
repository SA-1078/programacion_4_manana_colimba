  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · DummyJSON Smartphones',
      ...
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · DummyJSON Smartphones - Users',
        icono: Icons.network_ping,
      ...
      _PasoInfo(
        ...
        detalle: 'EquipoDto.fromJson · Catálogo de Celulares',
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Módulo 12 — API REST Equipos Móviles'),
