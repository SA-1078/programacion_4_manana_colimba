    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar.large(
            title:           const Text('Catálogo de Smartphones'),
            pinned:          true,
              ...
              background: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Icon(Icons.smartphone, size: 48, color: cs.onPrimaryContainer),
                    const SizedBox(height: 8),
                    Text(
                      '45 equipos en exhibición',
              ...
              delegate: SliverChildBuilderDelegate(
                (context, i) => Card(
                  child: ListTile(
                    ...
                    title:    Text('Samsung Galaxy S24 - Lote ${i + 1}'),
