  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Smartphonees', valor: '8',  icono: Icons.smartphone,          color: cs.primaryContainer)),
...
class _PantallaSmartphonees extends StatelessWidget {
  const _PantallaSmartphonees();
...
class _PantallaAlertas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const alertas = [
      (smartphone: 'prod-db-01',  mensaje: 'CPU > 90%',         nivel: 'CRÍTICO'),
      (smartphone: 'prod-web-03', mensaje: 'Disco al 85%',      nivel: 'AVISO'),
      (smartphone: 'prod-api-02', mensaje: 'Reinicio inesperado', nivel: 'CRÍTICO'),
    ];
