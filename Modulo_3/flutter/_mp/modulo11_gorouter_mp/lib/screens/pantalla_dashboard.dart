...
class PantallaDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final smartphones = servidoresSimulados;
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  children: [
                    _buildQuickActionButton(
                      context,
                      label: 'Ver Smartphones',
                      icon: Icons.smartphone,
                      onTap: () => context.go('/smartphones'),
                      color: cs.primary,
                    ),
                    _buildQuickActionButton(
                      context,
              ...
              Row(
                ...
                children: [
                  const Text(
                    'Estado de Smartphones',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                  ),
                  TextButton(
                    onPressed: () => context.go('/smartphones'),
                ...
                itemBuilder: (context, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        context.push('/smartphones/${s.id}', extra: s);
                      },
                    ),
                  );
                },
